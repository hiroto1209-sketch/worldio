const CACHE='worldio-v4';
const SHELL=['./','./index.html','./styles.css','./manifest.webmanifest','./icon.svg','./src/config.js','./src/storage.js','./src/radio.js','./src/map.js','./src/player.js','./src/app.js'];
